...
public class Posts {
    ...
    private String lastEditDate = "[no edit date]";
    private String lastActivityDate = "[no last activity date]";
    private String communityOwnedDate = "[no community owned date]";
    private String closedDate = "[no closed date]";
